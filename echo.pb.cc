...
void protobuf_AddDesc_echo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\necho.proto\022\006satifs\"\036\n\013EchoRequest\022\017\n\007m"
    "essage\030\001 \002(\t\"\037\n\014EchoResponse\022\017\n\007message\030"
    "\001 \002(\t2@\n\013EchoService\0221\n\004Echo\022\023.satifs.Ec"
    "hoRequest\032\024.satifs.EchoResponseB\003\200\001\001", 156);
...
EchoRequest::EchoRequest()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:satifs.EchoRequest)
}
...
EchoRequest::EchoRequest(const EchoRequest& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:satifs.EchoRequest)
}
...
EchoRequest::~EchoRequest() {
  // @@protoc_insertion_point(destructor:satifs.EchoRequest)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:satifs.EchoRequest)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:satifs.EchoRequest)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:satifs.EchoRequest)
  return false;
#undef DO_
}
...
void EchoRequest::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:satifs.EchoRequest)
  // required string message = 1;
  if (has_message()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->message().data(), this->message().length(),
  ...
  // @@protoc_insertion_point(serialize_end:satifs.EchoRequest)
}

::google::protobuf::uint8* EchoRequest::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:satifs.EchoRequest)
  // required string message = 1;
  if (has_message()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->message().data(), this->message().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:satifs.EchoRequest)
  return target;
}
...
EchoResponse::EchoResponse()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:satifs.EchoResponse)
}
...
EchoResponse::EchoResponse(const EchoResponse& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:satifs.EchoResponse)
}
...
EchoResponse::~EchoResponse() {
  // @@protoc_insertion_point(destructor:satifs.EchoResponse)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:satifs.EchoResponse)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:satifs.EchoResponse)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:satifs.EchoResponse)
  return false;
#undef DO_
}
...
void EchoResponse::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:satifs.EchoResponse)
  // required string message = 1;
  if (has_message()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->message().data(), this->message().length(),
  ...
  // @@protoc_insertion_point(serialize_end:satifs.EchoResponse)
}

::google::protobuf::uint8* EchoResponse::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:satifs.EchoResponse)
  // required string message = 1;
  if (has_message()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->message().data(), this->message().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:satifs.EchoResponse)
  return target;
}
...
void EchoService::CallMethod(const ::google::protobuf::MethodDescriptor* method,
  ...
  switch(method->index()) {
    case 0:
      Echo(controller,
             ::google::protobuf::down_cast<const ::satifs::EchoRequest*>(request),
             ::google::protobuf::down_cast< ::satifs::EchoResponse*>(response),
             done);
      break;
    default:
...
const ::google::protobuf::Message& EchoService::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::satifs::EchoRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::google::protobuf::Message& EchoService::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::satifs::EchoResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *reinterpret_cast< ::google::protobuf::Message*>(NULL);
  }
